...
class Settings:
    ...
    llm_model: str = os.getenv("LLM_MODEL", "qwen3.8-flash")
    ...
    enable_thinking: bool = os.getenv(
    ...
    saved_memories_path: str = os.getenv(
        "SAVED_MEMORIES_PATH", str(BASE_DIR / "data" / "saved_memories.json")
    )
    ...
    @property
    def saved_memories_file(self) -> Path:
        path = Path(self.saved_memories_path)
        return path if path.is_absolute() else BASE_DIR / path
    ...
    def public_status(self) -> dict[str, object]:
        return {
            ...
            "llm_enable_thinking": self.enable_thinking,
