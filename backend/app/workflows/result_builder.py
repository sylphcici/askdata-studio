...
class ResultBuilder:
    ...
    def completed(
        ...
        return QueryResult(
            ...
            rows=combined.rows,
            total_row_count=combined.total_row_count or len(combined.rows),
            rows_truncated=combined.truncated,
            ...
            schema_graph=graph,
            workflow_mode=mode,
            summary_faithful=final.get("summary_faithful"),
            summary_guard_used=bool(final.get("summary_guard_used")),
            summary_fidelity_issues=list(final.get("summary_fidelity_issues") or []),
            verified_facts=final.get("verified_facts"),
        )
